            ...
            function move() {
                $lis.each(function(index, element) {
                    ...
                    var state = states[index];
                      ...
                      // var stateMobile = statesMobile[index];
                      // states[1].css("display", "none")
    
                    
                      
       
    
                    //     var y = $('li').filter(function() {
                    //         return this.style.zIndex == '3'});
                    //         var z = $('li').filter(function() {
                    //             return this.style.zIndex == '2'});
                    
                    // x.removeClass("mobileTeam");
                    // y.addClass("mobileTeam");
                    // z.addClass("mobileTeam");
